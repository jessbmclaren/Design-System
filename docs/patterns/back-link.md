...
Place the back link above the page title, aligned to the left edge of the content. Name the specific destination rather than using a generic "Back" — the label doubles as a breadcrumb, reminding people where they are in the hierarchy and where a click will take them.
