...
- Don't build a parallel set of ad-hoc cell widgets — reach for the built-in types so sorting, alignment and editing stay coherent across the grid.
