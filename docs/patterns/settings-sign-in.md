...
- Don't clutter the sign-in with non-essential context, marketing copy or multiple competing actions.
- Don't show settings controls before the connection is authenticated.
- Don't collect credentials inline; the primary action should hand off to a dedicated authentication flow.
