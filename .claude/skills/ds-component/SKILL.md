...
Follow every step. A component is not done until all of them pass. See `CLAUDE.md` for the atomic-design, token, accessibility and writing-style rules this depends on.
