...
class DsFormFieldGroup extends StatelessWidget {
  ...
  /// gap between rows and the horizontal gutter between columns). Defaults to
  /// `16`.
  ...
  /// A single full-width column of children separated by [spacing].
  ...
  /// gutter, wrapping to new rows as needed.
  Widget _buildTwoColumn(double width) {
    ...
    final itemWidth = ((width - spacing) / 2).floorToDouble();
    return Wrap(
      spacing: spacing,
      runSpacing: spacing,
      children: [
