...
/// Data → Data grid.
final PatternPage dataGridPage = PatternPage(
  id: 'data-grid',
  group: DocGroup.data,
  navTitle: 'Data grid',
  title: 'Data grid',
  description:
      ...
      'resize by dragging their trailing edge. Below `compactBreakpoint` the '
      'whole grid re-flows into stacked cards, so the same data reads cleanly '
      'from a 320dp phone up to a wall-width desktop.',
  blocks: const [
    ProseBlock(
      'The grid is deliberately unopinionated about where its data comes from '
...
''',
  shots: const [
    Shot(pageId: 'data-grid', size: ShotSize.desktop),
    Shot(pageId: 'data-grid', size: ShotSize.phone),
  ],
  hasLiveDemo: true,
