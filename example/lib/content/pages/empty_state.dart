...
final PatternPage emptyStatePage = PatternPage(
  ...
  blocks: const [
    ProseBlock(
      ...
      'that creates the first one. When an active filter or search simply '
      'returns no matches, swap the message to explain that nothing meets the '
  ...
  dos: const [
    'Explain why the view is empty, using "yet" when records simply haven\'t been created.',
