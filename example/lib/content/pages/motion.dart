...
final PatternPage motionPage = PatternPage(
  ...
  description:
      ...
      'subtle overshoot instead of snapping — the difference between an '
      ...
      'stagger helper for choreographing a group. Reach for the tokens, not '
  ...
  blocks: const [
    ...
    ProseBlock(
      'And one law above all: **respect reduced motion.** When a person has '
  ...
  dos: const [
    'Reach for the duration scale and curves; a bespoke millisecond value is a '
  ...
  donts: const [
    ...
    "Don't reach for a bouncy elastic curve — `settle` gives a hint of "
