...
final PatternPage barChartPage = PatternPage(
  ...
  description:
      ...
      'baseline-anchored bars. It is the clearest way to answer "which is '
      ...
      'shares one hue from the data-visualisation palette, so the eye reads '
  ...
  donts: const [
    ...
    'Don\'t plot more than one series here; use a grouped chart or a line chart instead.',
