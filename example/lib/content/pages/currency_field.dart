...
final PatternPage currencyFieldPage = PatternPage(
  ...
  dos: const [
    ...
    'Treat the null value onChanged reports for an empty or half-typed amount as "no value yet" rather than zero.',
  ...
  donts: const [
    ...
    "Don't use a plain text field and post-process the string when you need a money value; this field guarantees a parseable num.",
  ],
  code: '''
DsCurrencyField(
  label: 'Amount',
