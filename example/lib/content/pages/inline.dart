...
final PatternPage inlinePage = PatternPage(
  ...
  title: 'Inline',
  description:
      '`DsInline` styles a single run of text (bold, italic, monospace `code` or '
      'strikethrough) so a sentence can carry emphasis without leaving the '
      ...
      '`DsInline.span` helper to combine several treatments in one `Text.rich` '
      'paragraph. Because it renders a plain `Text` with no state, timers or '
      'network work, it stays predictable everywhere it appears.',
  hasLiveDemo: true,
  dos: const [
