...
final PatternPage textAreaPage = PatternPage(
  ...
  title: 'Text area',
  description:
      'The text area gives people room to write more than a line: notes, '
      'descriptions, feedback or a short message. '
      ...
      '`helperText` in secondary text or, when validation fails, swaps to '
      ...
      'of that caption row. It gives writers a running budget and stops input '
      'at the limit.',
  hasLiveDemo: true,
  blocks: const [
    ProseBlock(
