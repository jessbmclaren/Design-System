  ...
  blocks: const [
    ...
    VariablesBlock(
      ...
      rows: [
        ...
        VariableRow(name: 'buttonPrimaryDisabledColorBackground', type: 'Color', example: '#800074D4', description: 'The background colour for disabled primary buttons (ARGB). Defaults to the primary background at 50% opacity; a skin can supply a solid tint instead.'),
