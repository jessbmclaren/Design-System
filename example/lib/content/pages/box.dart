...
final PatternPage boxPage = PatternPage(
  ...
  description:
      ...
      '`borderRadius` — rather than literal hex. Reach for it to build cards, '
  ...
  blocks: const [
    ProseBlock(
      ...
      '`width` or `height` sizes to its child and collapses gracefully to a '
      '320dp phone; supplying an `alignment` makes it expand to fill the '
      'available space, mirroring `Container`.',
    ),
  ],
  dos: const [
