...
final PatternPage additionalContextPage = PatternPage(
  ...
  description:
      ...
      'expose a small, on-demand explanation. The primary task stays front '
      'and centre, and people who want to read further can open it before they '
      'continue.',
  hasLiveDemo: true,
  blocks: const [
    ProseBlock(
      ...
      'Keep the hidden content to a few short sentences or bullet rows; if '
      'the explanation grows into paragraphs or requires acknowledgement, move '
      'it to a separate screen instead.',
    ),
  ],
  dos: const [
