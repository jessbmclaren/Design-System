...
final PatternPage menuPage = PatternPage(
  ...
  description:
      ...
      'Reach for it when a context has more than one or two actions, when those '
      'actions are secondary to the content itself, or when showing every '
      'choice inline would crowd the layout. Each item can carry a leading '
      'icon, be disabled when temporarily unavailable, or be marked '
      '`destructive` to render in the danger colour — and because the surface '
  ...
  blocks: const [
    ProseBlock(
      ...
      'such as Delete last, separated in intent from the routine choices above '
      'it. Pair any irreversible action with a confirmation step rather than '
      'relying on the menu alone.',
    ),
  ],
  dos: const [
