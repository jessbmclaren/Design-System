...
final PatternPage selectionControlsPage = PatternPage(
  ...
  description:
      ...
      'option or records a single consent — "I agree to the terms". A group of '
      ...
      '"Email me updates". Choosing the right control tells people, at a glance, '
  ...
  donts: const [
    'Do not use two radios for a single yes/no question — reach for one '
        'checkbox or a switch instead.',
