...
/// Loads the four bundled Inter faces under the family the default theme uses
/// (`packages/design_system/Inter`, see [DsTheme]) so golden text renders as
/// real glyphs instead of the blank test font. Idempotent and cheap after the
/// first call.
Future<void> loadDsFonts() async {
  if (_fontsLoaded) return;
  final loader = FontLoader('packages/design_system/Inter');
